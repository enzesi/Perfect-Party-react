...
class NewOptionPage extends React.Component {
  render() {
          ...
          <div className={classes.container}>
            <GridContainer>
              <GridItem xs={12} sm={12} md={6}>
                <h2 className={classes.title}>Add a new Product</h2>
                <br />
              </GridItem>
            </GridContainer>
          </div>
...
NewOptionPage.propTypes = {
  classes: PropTypes.object
};

export default withStyles(supplierPageStyle)(NewOptionPage);
